...
namespace Mozu.Api.Clients.Commerce.Catalog.Storefront
{
	...
	public partial class CategoryClient 	{
		...
		/// <example>
		/// <code>
		///   var mozuClient=GetCategories( filter,  startIndex,  pageSize,  sortBy, authTicket);
		///   var categoryPagedCollectionClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductRuntime.CategoryPagedCollection> GetCategoriesClient(string filter =  null, int? startIndex =  null, int? pageSize =  null, string sortBy =  null, AuthTicket authTicket= null)
		{
