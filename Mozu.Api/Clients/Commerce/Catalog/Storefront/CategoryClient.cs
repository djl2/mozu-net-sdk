...
namespace Mozu.Api.Clients.Commerce.Catalog.Storefront
{
	...
	public partial class CategoryClient 	{
		...
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductRuntime.CategoryPagedCollection> GetCategoriesClient(string filter, int? pageSize, string sortBy, int? startIndex)
		{
		...
		{
			return GetCategoryClient( null,  categoryId);
		}
		...
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductRuntime.Category> GetCategoryClient(bool? allowInactive, int categoryId)
		{
