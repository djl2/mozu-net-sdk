...
namespace Mozu.Api.Clients.Commerce.Catalog.Admin
{
	...
	public partial class ProductReservationClient 	{
		...
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.ProductReservationCollection> GetProductReservationsClient()
		{
		...
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.ProductReservationCollection> GetProductReservationsClient(string filter, int? pageSize, string sortBy, int? startIndex)
		{
			...
			var mozuClient = new MozuClient<Mozu.Api.Contracts.ProductAdmin.ProductReservationCollection>().WithVerb(verb).WithResourceUrl(url);
		return mozuClient;
		...
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.ProductReservation> GetProductReservationClient(int productReservationId)
		{
			var url = Mozu.Api.Urls.Commerce.Catalog.Admin.ProductReservationUrl.GetProductReservationUrl(productReservationId);
			const string verb = "GET";
			var mozuClient = new MozuClient<Mozu.Api.Contracts.ProductAdmin.ProductReservation>().WithVerb(verb).WithResourceUrl(url);
		return mozuClient;
		...
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.ProductReservation> AddProductReservationClient(Mozu.Api.Contracts.ProductAdmin.ProductReservation productReservation)
		{
			var url = Mozu.Api.Urls.Commerce.Catalog.Admin.ProductReservationUrl.AddProductReservationUrl();
			const string verb = "POST";
			var mozuClient = new MozuClient<Mozu.Api.Contracts.ProductAdmin.ProductReservation>().WithVerb(verb).WithResourceUrl(url).WithBody<Mozu.Api.Contracts.ProductAdmin.ProductReservation>(productReservation);
		return mozuClient;
		...
		/// </code>
		/// </example>
		public static MozuClient CommitReservationClient(int productReservationId, int qty)
		{
		...
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.ProductReservation> UpdateProductReservationClient(int productReservationId, Mozu.Api.Contracts.ProductAdmin.ProductReservation productReservation)
		{
