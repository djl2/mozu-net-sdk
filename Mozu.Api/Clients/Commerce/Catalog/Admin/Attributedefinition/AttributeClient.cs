...
namespace Mozu.Api.Clients.Commerce.Catalog.Admin.Attributedefinition
{
	...
	public partial class AttributeClient 	{
		...
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.AttributeCollection> GetAttributesClient()
		{
		...
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.AttributeCollection> GetAttributesClient(string filter, int? pageSize, string sortBy, int? startIndex)
		{
			...
			var mozuClient = new MozuClient<Mozu.Api.Contracts.ProductAdmin.AttributeCollection>().WithVerb(verb).WithResourceUrl(url);
		return mozuClient;
		...
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.Attribute> GetAttributeClient(string attributeFQN)
		{
			var url = Mozu.Api.Urls.Commerce.Catalog.Admin.Attributedefinition.AttributeUrl.GetAttributeUrl(attributeFQN);
			const string verb = "GET";
			var mozuClient = new MozuClient<Mozu.Api.Contracts.ProductAdmin.Attribute>().WithVerb(verb).WithResourceUrl(url);
		return mozuClient;
		...
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.Attribute> AddAttributeClient(Mozu.Api.Contracts.ProductAdmin.Attribute attribute)
		{
			var url = Mozu.Api.Urls.Commerce.Catalog.Admin.Attributedefinition.AttributeUrl.AddAttributeUrl();
			const string verb = "POST";
			var mozuClient = new MozuClient<Mozu.Api.Contracts.ProductAdmin.Attribute>().WithVerb(verb).WithResourceUrl(url).WithBody<Mozu.Api.Contracts.ProductAdmin.Attribute>(attribute);
		return mozuClient;
		...
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.Attribute> UpdateAttributeClient(string attributeFQN, Mozu.Api.Contracts.ProductAdmin.Attribute attribute)
		{
