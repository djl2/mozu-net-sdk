...
namespace Mozu.Api.Clients.Commerce.Catalog.Admin.Attributedefinition.Attributes
{
	...
	public partial class AttributeTypeRuleClient 	{
		...
		/// <example>
		/// <code>
		///   var mozuClient=GetAttributeTypeRules(dataViewMode,  startIndex,  pageSize,  sortBy,  filter, authTicket);
		///   var attributeTypeRuleCollectionClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.AttributeTypeRuleCollection> GetAttributeTypeRulesClient(DataViewMode dataViewMode, int? startIndex =  null, int? pageSize =  null, string sortBy =  null, string filter =  null, AuthTicket authTicket= null)
		{
