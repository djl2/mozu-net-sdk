...
namespace Mozu.Api.Clients.Commerce.Catalog.Admin.Attributedefinition.Producttypes
{
	...
	public partial class ProductTypePropertyClient 	{
		...
		/// <example>
		/// <code>
		///   var mozuClient=GetProperty(dataViewMode,  productTypeId,  attributeFQN, authTicket);
		///   var attributeInProductTypeClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.AttributeInProductType> GetPropertyClient(DataViewMode dataViewMode, int productTypeId, string attributeFQN, AuthTicket authTicket= null)
		{
		...
		/// <example>
		/// <code>
		///   var mozuClient=UpdateProperty(dataViewMode,  attributeInProductType,  productTypeId,  attributeFQN, authTicket);
		///   var attributeInProductTypeClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.ProductAdmin.AttributeInProductType> UpdatePropertyClient(DataViewMode dataViewMode, Mozu.Api.Contracts.ProductAdmin.AttributeInProductType attributeInProductType, int productTypeId, string attributeFQN, AuthTicket authTicket= null)
		{
		...
		/// <example>
		/// <code>
		///   var mozuClient=DeleteProperty(dataViewMode,  productTypeId,  attributeFQN, authTicket);
		///mozuClient.WithBaseAddress(url).Execute();
		/// </code>
		/// </example>
		public static MozuClient DeletePropertyClient(DataViewMode dataViewMode, int productTypeId, string attributeFQN, AuthTicket authTicket= null)
		{
