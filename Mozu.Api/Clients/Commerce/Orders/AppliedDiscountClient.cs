...
namespace Mozu.Api.Clients.Commerce.Orders
{
	...
	public partial class AppliedDiscountClient 	{
		...
		/// <example>
		/// <code>
		///   var mozuClient=ApplyCoupon( orderId,  couponCode,  updateMode,  version, authTicket);
		///   var orderClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.CommerceRuntime.Orders.Order> ApplyCouponClient(string orderId, string couponCode, string updateMode =  null, string version =  null, AuthTicket authTicket= null)
		{
		...
		/// <example>
		/// <code>
		///   var mozuClient=RemoveCoupon( orderId,  couponCode,  updateMode,  version, authTicket);
		///   var orderClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.CommerceRuntime.Orders.Order> RemoveCouponClient(string orderId, string couponCode, string updateMode =  null, string version =  null, AuthTicket authTicket= null)
		{
