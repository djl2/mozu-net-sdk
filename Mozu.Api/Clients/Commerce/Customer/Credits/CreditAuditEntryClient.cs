...
namespace Mozu.Api.Clients.Commerce.Customer.Credits
{
	...
	public partial class CreditAuditEntryClient 	{
		...
		/// <example>
		/// <code>
		///   var mozuClient=GetAuditEntries( code,  startIndex,  pageSize,  sortBy,  filter, authTicket);
		///   var creditAuditEntryCollectionClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.Customer.Credit.CreditAuditEntryCollection> GetAuditEntriesClient(string code, int? startIndex =  null, int? pageSize =  null, string sortBy =  null, string filter =  null, AuthTicket authTicket= null)
		{
			...
			var mozuClient = new MozuClient<Mozu.Api.Contracts.Customer.Credit.CreditAuditEntryCollection>().WithVerb(verb).WithResourceUrl(url);
			if (authTicket != null)
