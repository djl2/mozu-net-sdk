...
namespace Mozu.Api.Clients.Commerce.Customer
{
	...
	public partial class CustomerGroupClient 	{
		...
		/// <example>
		/// <code>
		///   var mozuClient=GetGroups( startIndex,  pageSize,  sortBy,  filter, authTicket);
		///   var customerGroupCollectionClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.Customer.CustomerGroupCollection> GetGroupsClient(int? startIndex =  null, int? pageSize =  null, string sortBy =  null, string filter =  null, AuthTicket authTicket= null)
		{
