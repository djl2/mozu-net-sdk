...
namespace Mozu.Api.Clients.Commerce.Customer
{
	...
	public partial class CreditClient 	{
		...
		/// <example>
		/// <code>
		///   var mozuClient=GetCredits( startIndex,  pageSize,  sortBy,  filter, authTicket);
		///   var creditCollectionClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.Customer.Credit.CreditCollection> GetCreditsClient(int? startIndex =  null, int? pageSize =  null, string sortBy =  null, string filter =  null, AuthTicket authTicket= null)
		{
			var url = Mozu.Api.Urls.Commerce.Customer.CreditUrl.GetCreditsUrl(filter, pageSize, sortBy, startIndex);
			const string verb = "GET";
			var mozuClient = new MozuClient<Mozu.Api.Contracts.Customer.Credit.CreditCollection>().WithVerb(verb).WithResourceUrl(url);
			if (authTicket != null)
		...
		/// <example>
		/// <code>
		///   var mozuClient=GetCredit( code, authTicket);
		///   var creditClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.Customer.Credit.Credit> GetCreditClient(string code, AuthTicket authTicket= null)
		{
		...
		/// <example>
		/// <code>
		///   var mozuClient=AddCredit( credit, authTicket);
		///   var creditClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.Customer.Credit.Credit> AddCreditClient(Mozu.Api.Contracts.Customer.Credit.Credit credit, AuthTicket authTicket= null)
		{
			var url = Mozu.Api.Urls.Commerce.Customer.CreditUrl.AddCreditUrl();
			const string verb = "POST";
			var mozuClient = new MozuClient<Mozu.Api.Contracts.Customer.Credit.Credit>().WithVerb(verb).WithResourceUrl(url).WithBody<Mozu.Api.Contracts.Customer.Credit.Credit>(credit);
			if (authTicket != null)
				mozuClient = mozuClient.WithUserAuth(authTicket);
			return mozuClient;
		...
		/// <example>
		/// <code>
		///   var mozuClient=UpdateCredit( credit,  code, authTicket);
		///   var creditClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.Customer.Credit.Credit> UpdateCreditClient(Mozu.Api.Contracts.Customer.Credit.Credit credit, string code, AuthTicket authTicket= null)
		{
		...
		/// <example>
		/// <code>
		///   var mozuClient=DeleteCredit( code, authTicket);
		///mozuClient.WithBaseAddress(url).Execute();
		/// </code>
		/// </example>
		public static MozuClient DeleteCreditClient(string code, AuthTicket authTicket= null)
		{
