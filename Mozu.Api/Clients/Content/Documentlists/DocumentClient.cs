...
namespace Mozu.Api.Clients.Content.Documentlists
{
	...
	public partial class DocumentClient 	{
		...
		/// <example>
		/// <code>
		///   var mozuClient=GetDocument(dataViewMode,  documentListName,  documentId, authTicket);
		///   var documentClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.Content.Document> GetDocumentClient(DataViewMode dataViewMode, string documentListName, string documentId, AuthTicket authTicket= null)
		{
		...
		/// <example>
		/// <code>
		///   var mozuClient=GetDocumentContent(dataViewMode,  documentListName,  documentId, authTicket);
		///   var streamClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<System.IO.Stream> GetDocumentContentClient(DataViewMode dataViewMode, string documentListName, string documentId, AuthTicket authTicket= null)
		{
		...
		/// <example>
		/// <code>
		///   var mozuClient=GetDocuments(dataViewMode,  documentListName,  filter,  sortBy,  pageSize,  startIndex, authTicket);
		///   var documentCollectionClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.Content.DocumentCollection> GetDocumentsClient(DataViewMode dataViewMode, string documentListName, string filter =  null, string sortBy =  null, int? pageSize =  null, int? startIndex =  null, AuthTicket authTicket= null)
		{
			...
			const string verb = "GET";
			var mozuClient = new MozuClient<Mozu.Api.Contracts.Content.DocumentCollection>().WithVerb(verb).WithResourceUrl(url).WithHeader(Headers.X_VOL_DATAVIEW_MODE ,dataViewMode.ToString());
			if (authTicket != null)
				mozuClient = mozuClient.WithUserAuth(authTicket);
			return mozuClient;
		...
		/// <example>
		/// <code>
		///   var mozuClient=CreateDocument(dataViewMode,  document,  documentListName, authTicket);
		///   var documentClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.Content.Document> CreateDocumentClient(DataViewMode dataViewMode, Mozu.Api.Contracts.Content.Document document, string documentListName, AuthTicket authTicket= null)
		{
			var url = Mozu.Api.Urls.Content.Documentlists.DocumentUrl.CreateDocumentUrl(documentListName);
			const string verb = "POST";
			var mozuClient = new MozuClient<Mozu.Api.Contracts.Content.Document>().WithVerb(verb).WithResourceUrl(url).WithBody<Mozu.Api.Contracts.Content.Document>(document).WithHeader(Headers.X_VOL_DATAVIEW_MODE ,dataViewMode.ToString());
			if (authTicket != null)
				mozuClient = mozuClient.WithUserAuth(authTicket);
			return mozuClient;
		...
		/// <example>
		/// <code>
		///   var mozuClient=UpdateDocument(dataViewMode,  document,  documentListName,  documentId, authTicket);
		///   var documentClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.Content.Document> UpdateDocumentClient(DataViewMode dataViewMode, Mozu.Api.Contracts.Content.Document document, string documentListName, string documentId, AuthTicket authTicket= null)
		{
		...
		/// <example>
		/// <code>
		///   var mozuClient=UpdateDocumentContent(dataViewMode,  stream,  documentListName,  documentId, authTicket);
		///mozuClient.WithBaseAddress(url).Execute();
		/// </code>
		/// </example>
		public static MozuClient UpdateDocumentContentClient(DataViewMode dataViewMode, System.IO.Stream stream, string documentListName, string documentId, AuthTicket authTicket= null)
		{
		...
		/// <example>
		/// <code>
		///   var mozuClient=DeleteDocument(dataViewMode,  documentListName,  documentId, authTicket);
		///mozuClient.WithBaseAddress(url).Execute();
		/// </code>
		/// </example>
		public static MozuClient DeleteDocumentClient(DataViewMode dataViewMode, string documentListName, string documentId, AuthTicket authTicket= null)
		{
		...
		/// <example>
		/// <code>
		///   var mozuClient=DeleteDocumentContent(dataViewMode,  documentListName,  documentId, authTicket);
		///mozuClient.WithBaseAddress(url).Execute();
		/// </code>
		/// </example>
		public static MozuClient DeleteDocumentContentClient(DataViewMode dataViewMode, string documentListName, string documentId, AuthTicket authTicket= null)
		{
