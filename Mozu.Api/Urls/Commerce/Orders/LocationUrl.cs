...
namespace Mozu.Api.Urls.Commerce.Orders
{
	public partial class LocationUrl : BaseUrl
	{
		...
		{
			var url = "/api/commerce/orders/locations/locations/{locationId}";
		...
		{
			var url = "/api/commerce/orders/locations/locations?name={name}&";
		...
		{
			var url = "/api/commerce/orders/locations/locations?pageIndex={startIndex}&pageSize={pageSize}&sortBy={sortBy}&&filter={filter}";
