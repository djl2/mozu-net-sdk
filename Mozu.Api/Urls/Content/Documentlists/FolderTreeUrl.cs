...
{
	public partial class FolderTreeUrl 
	{
        ...
        public static MozuUrl GetFolderTreeUrl(string documentListName, int? levels, string rootFolderId, string rootFolderPath)
		{
			...
			mozuUrl.FormatUrl( "levels", levels);
			mozuUrl.FormatUrl( "rootFolderId", rootFolderId);
			mozuUrl.FormatUrl( "rootFolderPath", rootFolderPath);
			return mozuUrl;
		}
