...
namespace Mozu.Api.Resources.Commerce.Orders
{
	...
	public partial class FulfillmentActionResource  	{
		...
		///   var fulfillmentInfo = fulfillmentaction.GetFulfillmentInfo( orderId);
		/// </code>
		/// </example>
		...
		/// <code>
		///   var fulfillmentaction = new FulfillmentAction();
		///   var fulfillmentInfo = fulfillmentaction.GetFulfillmentInfo( orderId,  draft, authTicket);
		/// </code>
		/// </example>
		public virtual Mozu.Api.Contracts.CommerceRuntime.Fulfillment.FulfillmentInfo GetFulfillmentInfo(string orderId, bool? draft =  null, AuthTicket authTicket= null)
		{
			...
			var client = Mozu.Api.Clients.Commerce.Orders.FulfillmentActionClient.GetFulfillmentInfoClient( orderId,  draft, authTicket);
		...
		/// <code>
		///   var fulfillmentaction = new FulfillmentAction();
		///   var fulfillmentInfo = fulfillmentaction.SetFulFillmentInfo( fulfillmentInfo,  orderId);
		/// </code>
		/// </example>
		...
		/// <code>
		///   var fulfillmentaction = new FulfillmentAction();
		///   var fulfillmentInfo = fulfillmentaction.SetFulFillmentInfo( fulfillmentInfo,  orderId,  updateMode,  version, authTicket);
		/// </code>
		/// </example>
		...
		{
			MozuClient<Mozu.Api.Contracts.CommerceRuntime.Fulfillment.FulfillmentInfo> response;
			var client = Mozu.Api.Clients.Commerce.Orders.FulfillmentActionClient.SetFulFillmentInfoClient( fulfillmentInfo,  orderId,  updateMode,  version, authTicket);
			client.WithContext(_apiContext);
			response= client.Execute();
			return response.Result();
