...
namespace Mozu.Api.Resources.Commerce.Storefront
{
	/// <summary>
	/// 
	/// </summary>
	public partial class LocationResource  	{
		...
		public virtual Mozu.Api.Contracts.Location.Location GetLocation(string code, AuthTicket authTicket= null)
		{
			...
			var client = Mozu.Api.Clients.Commerce.Storefront.LocationClient.GetLocationClient( code, authTicket);
		...
		{
			MozuClient<Mozu.Api.Contracts.Location.Location> response;
			var client = Mozu.Api.Clients.Commerce.Storefront.LocationClient.GetLocationInUsageTypeClient( locationUsageType,  code, authTicket);
			client.WithContext(_apiContext);
			response= client.Execute();
			return response.Result();
		...
		public virtual Mozu.Api.Contracts.Location.LocationCollection GetLocationsInUsageType(string locationUsageType, int? startIndex =  null, int? pageSize =  null, string sortBy =  null, string filter =  null, AuthTicket authTicket= null)
		{
			...
			var client = Mozu.Api.Clients.Commerce.Storefront.LocationClient.GetLocationsInUsageTypeClient( locationUsageType,  startIndex,  pageSize,  sortBy,  filter, authTicket);
			client.WithContext(_apiContext);
			response= client.Execute();
			return response.Result();
		...
		{
			MozuClient<Mozu.Api.Contracts.Location.Location> response;
			var client = Mozu.Api.Clients.Commerce.Storefront.LocationClient.GetDirectShipLocationClient(authTicket);
			client.WithContext(_apiContext);
			response= client.Execute();
			return response.Result();
		...
		{
			MozuClient<Mozu.Api.Contracts.Location.Location> response;
			var client = Mozu.Api.Clients.Commerce.Storefront.LocationClient.GetInStorePickupLocationClient( code, authTicket);
			client.WithContext(_apiContext);
			response= client.Execute();
			return response.Result();
		...
		{
			MozuClient<Mozu.Api.Contracts.Location.LocationCollection> response;
			var client = Mozu.Api.Clients.Commerce.Storefront.LocationClient.GetInStorePickupLocationsClient( startIndex,  pageSize,  sortBy,  filter, authTicket);
			client.WithContext(_apiContext);
			response= client.Execute();
			return response.Result();
