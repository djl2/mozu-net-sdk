...
namespace Mozu.Api.Resources.Commerce.Catalog.Admin
{
	...
	public partial class CategoryResource  	{
		...
		/// <code>
		///   var category = new Category();
		///   var categoryPagedCollection = category.GetCategories(dataViewMode,  startIndex,  pageSize,  sortBy,  filter, authTicket);
		/// </code>
		/// </example>
		public virtual Mozu.Api.Contracts.ProductAdmin.CategoryPagedCollection GetCategories(DataViewMode dataViewMode, int? startIndex =  null, int? pageSize =  null, string sortBy =  null, string filter =  null, AuthTicket authTicket= null)
		{
			MozuClient<Mozu.Api.Contracts.ProductAdmin.CategoryPagedCollection> response;
			var client = Mozu.Api.Clients.Commerce.Catalog.Admin.CategoryClient.GetCategoriesClient(dataViewMode,  startIndex,  pageSize,  sortBy,  filter, authTicket);
