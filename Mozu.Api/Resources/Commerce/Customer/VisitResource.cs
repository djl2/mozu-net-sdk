...
namespace Mozu.Api.Resources.Commerce.Customer
{
	...
	public partial class VisitResource  	{
		...
		/// <code>
		///   var visit = new Visit();
		///   var visitCollection = visit.GetVisits( startIndex,  pageSize,  sortBy,  filter, authTicket);
		/// </code>
		/// </example>
		public virtual Mozu.Api.Contracts.Customer.VisitCollection GetVisits(int? startIndex =  null, int? pageSize =  null, string sortBy =  null, string filter =  null, AuthTicket authTicket= null)
		{
			MozuClient<Mozu.Api.Contracts.Customer.VisitCollection> response;
			var client = Mozu.Api.Clients.Commerce.Customer.VisitClient.GetVisitsClient( startIndex,  pageSize,  sortBy,  filter, authTicket);
