...
namespace Mozu.Api.Resources.Commerce.Customer.Credits
{
	...
	public partial class CreditTransactionResource  	{
		...
		/// <code>
		///   var credittransaction = new CreditTransaction();
		///   var creditTransactionCollection = credittransaction.GetTransactions( code,  startIndex,  pageSize,  sortBy,  filter, authTicket);
		/// </code>
		/// </example>
		public virtual Mozu.Api.Contracts.Customer.Credit.CreditTransactionCollection GetTransactions(string code, int? startIndex =  null, int? pageSize =  null, string sortBy =  null, string filter =  null, AuthTicket authTicket= null)
		{
			MozuClient<Mozu.Api.Contracts.Customer.Credit.CreditTransactionCollection> response;
			var client = Mozu.Api.Clients.Commerce.Customer.Credits.CreditTransactionClient.GetTransactionsClient( code,  startIndex,  pageSize,  sortBy,  filter, authTicket);
		...
		/// <code>
		///   var credittransaction = new CreditTransaction();
		///   var creditTransaction = credittransaction.AddTransaction( creditTransaction,  code, authTicket);
		/// </code>
		/// </example>
		public virtual Mozu.Api.Contracts.Customer.Credit.CreditTransaction AddTransaction(Mozu.Api.Contracts.Customer.Credit.CreditTransaction creditTransaction, string code, AuthTicket authTicket= null)
		{
			MozuClient<Mozu.Api.Contracts.Customer.Credit.CreditTransaction> response;
			var client = Mozu.Api.Clients.Commerce.Customer.Credits.CreditTransactionClient.AddTransactionClient( creditTransaction,  code, authTicket);
			client.WithContext(_apiContext);
			response= client.Execute();
			return response.Result();
