...
namespace Mozu.Api.Test.Factories
{
	...
	/// 
	/// </summary>
	public partial class StorefrontLocationFactory : BaseDataFactory
	{
		 ...
		 HttpStatusCode expectedCode = HttpStatusCode.OK, HttpStatusCode successCode = HttpStatusCode.OK)
		{
			...
			var apiClient = Mozu.Api.Clients.Commerce.Storefront.LocationClient.GetLocationClient(
			...
			catch (ApiException ex)
			{
				...
				var printableError = string.Format("{0} || {1}.{2} {3} Error: {4}", ex.HttpStatusCode.ToString(), currentClassName, currentMethodName, ex.ExceptionDetail.TargetSite ?? "", ex.Message ?? "");
				Debug.WriteLine(printableError);
				if (ex.HttpStatusCode == HttpStatusCode.NotFound)
				    return null;
				throw (new TestFailException(apiClient.HttpResponse.StatusCode, currentMethodName, expectedCode, printableError));
			}
		 ...
		 HttpStatusCode expectedCode = HttpStatusCode.OK, HttpStatusCode successCode = HttpStatusCode.OK)
		{
			...
			var currentMethodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
			Debug.WriteLine(currentMethodName  + '.' + currentMethodName );
			var apiClient = Mozu.Api.Clients.Commerce.Storefront.LocationClient.GetLocationInUsageTypeClient(
		 ...
		 HttpStatusCode expectedCode = HttpStatusCode.OK, HttpStatusCode successCode = HttpStatusCode.OK)
		{
			...
			var currentMethodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
			Debug.WriteLine(currentMethodName  + '.' + currentMethodName );
			var apiClient = Mozu.Api.Clients.Commerce.Storefront.LocationClient.GetLocationsInUsageTypeClient(
		 ...
		 HttpStatusCode expectedCode = HttpStatusCode.OK, HttpStatusCode successCode = HttpStatusCode.OK)
		{
			...
			var currentMethodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
			Debug.WriteLine(currentMethodName  + '.' + currentMethodName );
			var apiClient = Mozu.Api.Clients.Commerce.Storefront.LocationClient.GetDirectShipLocationClient(
		 ...
		 HttpStatusCode expectedCode = HttpStatusCode.OK, HttpStatusCode successCode = HttpStatusCode.OK)
		{
			...
			var currentMethodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
			Debug.WriteLine(currentMethodName  + '.' + currentMethodName );
			var apiClient = Mozu.Api.Clients.Commerce.Storefront.LocationClient.GetInStorePickupLocationClient(
				 code :  code, authTicket : authTicket		);
			try
			{
				apiClient.WithContext(handler.ApiContext).Execute();
		 ...
		 HttpStatusCode expectedCode = HttpStatusCode.OK, HttpStatusCode successCode = HttpStatusCode.OK)
		{
			...
			var currentMethodName = System.Reflection.MethodBase.GetCurrentMethod().Name;
			Debug.WriteLine(currentMethodName  + '.' + currentMethodName );
			var apiClient = Mozu.Api.Clients.Commerce.Storefront.LocationClient.GetInStorePickupLocationsClient(
