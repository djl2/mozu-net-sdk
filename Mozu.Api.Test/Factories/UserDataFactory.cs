...
namespace Mozu.Api.Test.Factories
{
	...
	/// <summary> 
		...
		/// UserDataFactory.GetDBValue(handler : handler,  dbEntryQuery :  dbEntryQuery,  expectedCode: expectedCode, successCode: successCode); 
		...
		/// UserDataFactory.CreateDBValue(handler : handler,  dbEntryQuery :  dbEntryQuery,  value :  value,  expectedCode: expectedCode, successCode: successCode); 
		...
		/// UserDataFactory.UpdateDBValue(handler : handler,  dbEntryQuery :  dbEntryQuery,  value :  value,  expectedCode: expectedCode, successCode: successCode); 
		/// var casted = JsonConvert.DeserializeObject<void>(JsonConvert.SerializeObject(result)); 
		/// return casted;
		/// </summary>
		...
		/// UserDataFactory.DeleteDBValue(handler : handler,  dbEntryQuery :  dbEntryQuery,  expectedCode: expectedCode, successCode: successCode); 
		/// var casted = JsonConvert.DeserializeObject<void>(JsonConvert.SerializeObject(result)); 
		/// return casted;
		/// </summary>
